...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('topycoon_scrape.log', encoding='utf-8'),
...
def main():
    ...
    if not app_id:
        logger.error("TopTycoon的Google Play ID未配置！")
    ...
    # 保存数据
    output_path = f"data/raw/{game_name.replace(' ', '_')}_android_{region['name']}_202509-202512.json"
