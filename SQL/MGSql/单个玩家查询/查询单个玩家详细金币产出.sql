with tb_coin as (
    select cast(cast(proj_asset_value as bigint)/proj_reward_coin_multi as int) as reward_coin,proj_reward_coin_multi,proj_simple_game_id,proj_asset_source_type
